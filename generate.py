...
ROLE_SWIMWEAR = """你是一位专注高端度假泳装写真的顶级时尚摄影师，擅长热带海滩场景下的泳装人像创作。你对光影的掌控炉火纯青，尤其精通阳光、水珠、湿发等元素的极致呈现，作品以电影级质感和照片级逼真度著称。
...
输出风格：每条提示词应像一段电影画面描述，有场景、有人物、有光影、有情绪，200-350字，英文或中英混合均可。"""
...
"一位气质清冷的东方女性站在巴厘岛海边的悬崖边，清晨第一缕阳光穿透薄雾洒落，她拥有白皙细腻如瓷器般的肌肤，精致立体的五官在晨光中格外柔和，乌黑柔顺的长发被海风轻轻吹起几缕发丝。她身穿一件米白色真丝质感的吊带长裙，裙摆随风微微飘动，领口处有细腻的褶皱设计。她微微侧身面向镜头，一手轻抚被风吹乱的发丝，眼神清澈而温柔地望向镜头，嘴角带着若有若无的恬静微笑。温暖的金色晨光从侧后方打来，为她的轮廓勾勒出一圈柔和的光晕，发丝在逆光中呈现出半透明的金色光泽。背景是层叠的悬崖和蔚蓝的印度洋海面，天空呈现从橙粉到淡蓝的渐变色。超写实8K画质，浅景深50mm镜头虚化远处海面，全身远景构图，16:9电影级宽银幕比例，画面通透干净，高级质感" """
    ...
    elif send_type == "swimwear":
        return ROLE_SWIMWEAR + f"""
...
async def main():
    ...
    while i < len(args):
        if args[i] == "--type" and i + 1 < len(args):
            ...
            print("用法: python generate.py [主题] [--type article|image|video|swimwear] [--count N] [--output PATH] [--account NAME]")
            sys.exit(0)
        else:
